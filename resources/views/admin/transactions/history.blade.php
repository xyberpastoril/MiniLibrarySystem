                    ...
                    <tr class="text-start">
                        ...
                        <td>
                            @if($transaction->amount > 0 && $transaction->penalty_status == 'unpaid')
                                <a href="#" class="btn btn-icon btn-primary btn-sm" penalty-id="{{ $transaction->penalty_id }}" transaction-id="{{ $transaction->id }}" data-kt-transactions-table-filter="pay_row" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Pay Penalty">
