...
@section("content")
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <form id="book_update_form" method="POST" action="{{ route('books.update', $book->id) }}"  class="form" class="card-body p-9">
            @csrf
            @method('PUT')
                ...
                <div class="flex-md-row-fluid ms-lg-12">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-10 fv-row">
                            <input type="text" name="title" class="form-control form-control-lg form-control-solid" value="{{ $book->title }}" placeholder="Enter Book Title" required>
                        </div>
                    </div>
