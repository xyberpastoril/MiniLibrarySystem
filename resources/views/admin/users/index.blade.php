                ...
                <tbody class="text-gray-600 fw-bold">
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                <a href="{{ route('users.show', 1) }}">
                                    <div class="symbol-label">
                                        <img src="{{ asset("media/avatars/150-1.jpg") }}" alt="Emma Smith" class="w-100">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="d-flex flex-column">
                                <a href="{{ route('users.show', 1) }}" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!-- User details -->
                            <div class="d-flex flex-column">
                                <a href="user-details.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
