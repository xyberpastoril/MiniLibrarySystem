...
@section("custom_js")
    <script src="{{ asset("js/custom/user/transactions-page/transactions-history-table.js") }}"></script>
    <script src="{{ asset("js/custom/user/transactions-page/export-transactions.js") }}"></script>
@endsection