...
var KTBooksList = (function () {
    var e,
        ...
        l = () => {
            ...
            (t = document.querySelector('[data-kt-book-table-toolbar="base"]')),
                (n = document.querySelector(
                    '[data-kt-book-table-toolbar="selected"]'
                )),
                (r = document.querySelector(
                    '[data-kt-book-table-select="selected_count"]'
                ));
            const s = document.querySelector(
                '[data-kt-book-table-select="delete_selected"]'
            );
            c.forEach((e) => {
    ...
    return {
        init: function () {
            o &&
                ...
                l(),
                document
                    .querySelector('[data-kt-book-table-filter="search"]')
                    .addEventListener("keyup", function (t) {
                        e.search(t.target.value).draw();
                    }),
                document
                    .querySelector('[data-kt-book-table-filter="reset"]')
                    .addEventListener("click", function () {
                        document
                            .querySelector('[data-kt-book-table-filter="form"]')
                ...
                (() => {
                    const t = document.querySelector(
                        ...
                        n = t.querySelector(
                            '[data-kt-book-table-filter="filter"]'
                        ),
