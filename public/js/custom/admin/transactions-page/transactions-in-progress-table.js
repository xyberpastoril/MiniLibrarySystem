...
var claimedButton = document.getElementById("claimedButton"),
  returnedButton = document.getElementById("returnedButton");

claimedButton.addEventListener("click", (e) => {
  e.preventDefault();

  Swal.fire({
    text: "Successfully marked as claimed!",
    icon: "success",
  ...
  claimedButton.classList.add("visually-hidden");
  returnedButton.classList.remove("visually-hidden");
});
...
returnedButton.addEventListener("click", (e) => {
  ...
  Swal.fire({
    text: "Successfully marked as returned!",
    icon: "success",
    buttonsStyling: false,
    confirmButtonText: "Ok, got it!",
    customClass: {
  ...
  returnedButton.classList.add("visually-hidden");
  claimedButton.classList.remove("visually-hidden");
});
